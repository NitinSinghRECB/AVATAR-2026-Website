...
const TeamPage = () => {
  ...
  const faculty = [
    'Mr. Abhijeet Singh', 'Dr. Pushpendra Singh', 'Dr. Siddhartha Kumar Arjaria'
  ];
  ...
  const volunteers = [
    'Yogesh Singh', 'Satyam Maurya', 'Dhirendra Bind', 'Ali Ashab Shah', 'Kaushal Patel', 
    'Pappu Kumar', 'Ayush Kumar', 'Nitin Verma', 'Prashant Kumar', 'Rama Raman Pandey', 
